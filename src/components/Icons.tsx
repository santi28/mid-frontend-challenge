...
export function MaterialSymbolsListRounded(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function MaterialSymbolsAddNotesRounded(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function MaterialSymbolsOpenInFullRounded(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
...
export function MaterialSymbolsArrowWarmUpRounded(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
...
export function MaterialSymbolsSortByAlphaRounded(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
